...
export function validateEnvironment(): EnvironmentConfig {
  const requiredVars = {
    ...
    XTRACT_BACKEND_URL: process.env.XTRACT_BACKEND_URL || 'https://xtract-mpb1b1iq2-brians-projects-998b86c6.vercel.app',
    ALLOWED_ORIGINS: process.env.ALLOWED_ORIGINS?.split(',') || ['https://xtract-mpb1b1iq2-brians-projects-998b86c6.vercel.app'],
