...
export function validateEnvironment(): EnvironmentConfig {
  const requiredVars = {
    ...
    XTRACT_BACKEND_URL: process.env.XTRACT_BACKEND_URL || 'https://xtract-bkz9mt0lc-brians-projects-998b86c6.vercel.app',
    ALLOWED_ORIGINS: process.env.ALLOWED_ORIGINS?.split(',') || ['https://xtract-bkz9mt0lc-brians-projects-998b86c6.vercel.app'],
