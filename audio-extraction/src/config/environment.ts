...
export function validateEnvironment(): EnvironmentConfig {
  const requiredVars = {
    ...
    XTRACT_BACKEND_URL: process.env.XTRACT_BACKEND_URL || 'https://xtract-hvo8k5gfu-brians-projects-998b86c6.vercel.app',
    ALLOWED_ORIGINS: process.env.ALLOWED_ORIGINS?.split(',') || ['https://xtract-hvo8k5gfu-brians-projects-998b86c6.vercel.app'],
